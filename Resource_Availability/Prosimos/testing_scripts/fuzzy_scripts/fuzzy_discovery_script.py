...
def discover_model_from_csv_log(proc_name, g_size, angle, c_type, even):
    build_fuzzy_calendars(csv_log_path=get_file_path(proc_name, FileType.TRAINING_CSV_LOG, g_size, angle, 0, c_type, even),
                          bpmn_path=get_file_path(proc_name, FileType.BPMN, g_size, angle, 0, c_type, even),
                          json_path=get_file_path(proc_name, FileType.SIMULATION_JSON, g_size, angle, 0, c_type, even),
