...
def generate_base_sim_model(proc_name, total_cases, is_fuzzy):
    ...
    arrival_dates = get_arrival_times(total_cases, start_datetime, 108,
...
def _assign_resource_8_4_4_24_hours(p_info: ProcInfo, proc_name, traces, arrival_dates, start_datetime, is_even,
    ...
    _assign_times_to_tasks(proc_name, traces, arrival_dates, 4, is_even, r_calendars, is_fuzzy)
